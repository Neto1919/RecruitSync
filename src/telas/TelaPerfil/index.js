  ...
  return (
    <View style={styles.container}>
      <View style={styles.b1}>
        <View style={{ backgroundColor: '#4A5C6A', width: 400, height: 700, marginHorizontal: 45, borderRadius: 10 }}>
          ...
          <View style={{ marginTop: 10 }}>
            ...
            <View style={{ backgroundColor: 'white', width: 360, height: 100, borderRadius: 10, marginHorizontal: 20 }}>
              <View style={{ backgroundColor: 'black', width: 120, borderRadius: 10, marginHorizontal: 20, marginTop: 10 }}>
