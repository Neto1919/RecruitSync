    ...
    return (
      <View style={styles.container}>
        <View style={styles.b1}>
          ...
          <TextInput 
            style={{marginLeft: 10, borderWidth: 2, borderColor: 'white', marginHorizontal: 270, borderRadius: 10, padding: 10, margin: 10}}
            placeholder='Fletcher'
            placeholderTextColor={'#c1c1c1'}
          />

          <TextInput 
            style={{marginLeft: 250, borderWidth: 2, borderColor: 'white', marginHorizontal: 10, marginTop: -63, borderRadius: 10, padding: 10, margin: 10}}
